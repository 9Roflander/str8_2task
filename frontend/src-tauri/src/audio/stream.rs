...
impl AudioStream {
    ...
    async fn create_core_audio_stream(
        ...
        // Create Core Audio capture with app filtering
        info!("🔊 Stream: Calling CoreAudioCapture::new() with filter_apps: {:?}...", filter_apps);
        let capture_impl = CoreAudioCapture::new(filter_apps)
            .map_err(|e| {
