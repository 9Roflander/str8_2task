@echo off
REM str8_2task Build Script for Windows
...
echo 🚀 Building str8_2task application...
...
echo.
echo ========================================
echo    str8_2task Build Script - Help
echo ========================================
echo.
echo USAGE:
...
echo.
echo DESCRIPTION:
echo   This script builds the str8_2task Tauri application for Windows.
